from flat_game import carmunkExperiment1
import numpy as np
import random
import csv
import os.path
...
def learn():
    ...
    totalReward = 0.0
    fileObj = open("experiment1.csv", "w")

    # Create a new game instance.
    game_state = carmunkExperiment1.GameState()
    ...
    while e < episodes:
        ...
        while gameFinished == False:
             ...
             #if finish line is reached, reset agent to start position
             if(currentCell.end):
